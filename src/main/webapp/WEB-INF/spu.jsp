...
<body>
	spu product information admin
	<hr>
	Level 1:<select id="class_1_select" onchange="get_class_2(this.value);"><option>Please select</option></select>
	Level 2:<select id="class_2_select"><option>Please select</option></select>
	Brand:<select id="tm_select"><option>Please select</option></select>
	Find<br>
	<a href="javascript:goto_spu_add();">Add</a><br>
	Delete<br>
	Edit<br>
</body>
</html>