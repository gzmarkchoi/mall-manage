...
<body>
	<form action="save_sku.do">
		<input type="hidden" value="${flbh1}" name="flbh1" /> <input type="hidden" value="${flbh2}" name="flbh2" /> Brand:<select id="sku_tm_select" name="pp_id" onchange="get_spu_list(this.value)"></select> Product<select id="spu_list" name="id"></select>
		<hr>
		...
		Product stock name:<input type="text" name="sku_mch" /><br> Product stock quantity:<input type="text" name="kc" /><br> Product stock price:<input type="text" name="jg" /><br> Product stock address:<input type="text" name="kcdz" /><br> <input type="submit" value="Submit" />
	</form>
</body>
</html>