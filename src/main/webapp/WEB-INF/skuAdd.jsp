...
<body>
	<form action="save_sku.do">
		...
		Brand: <select id="sku_tm_select" name="pp_id" onchange="get_spu_list(this.value)"></select>
		Product<select id="spu_list" name="id"></select>
		<hr>
		...
		SKU name: <input type="text" name="sku_mch" /><br>
		SKU quantity: <input type="text" name="kc" /><br>
		SKU price: <input type="text" name="jg" /><br> 
		SKU address: <input type="text" name="kcdz" /><br> 
