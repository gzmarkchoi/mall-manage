...
<script type="text/javascript">
	...
	function replace_image(index) {
		...
		if ((index + 1) == length) {
			// make sure the image that user selected is the last one
			add_image(index);
		}
	}
...
<body>
	...
	<form action="spu_add.do" enctype="multipart/form-data" method="post">
		...
		Product description: <textarea name="shp_msh" rows="10" cols="50"></textarea>
		<br> Product images:<br>
		<div id="d_0" style="float: left; margin-left: 10px; border: 1px red solid;">
			<input id="file_0" type="file" name="files" style="display: none;" onchange="replace_image(0)" /> <img id="image_0" onclick="click_image(0)" style="cursor: pointer;" src="image/upload_hover.png" width="100px">
		</div>
